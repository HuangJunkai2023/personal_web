...
export default async function ProjectDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-24">
      ...
      <div className="mt-10 aspect-video rounded-2xl bg-gradient-to-br from-neutral-100 to-neutral-200 dark:from-neutral-800 dark:to-neutral-900 flex items-center justify-center">
        <span className="text-neutral-400 dark:text-neutral-600">Project Image</span>
      </div>
      ...
      <section className="mt-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {[1, 2, 3].map((n) => (
            <div
              key={n}
              className="aspect-[4/3] rounded-xl bg-gradient-to-br from-neutral-100 to-neutral-200 dark:from-neutral-800 dark:to-neutral-900 flex items-center justify-center"
            >
              <span className="text-neutral-400 dark:text-neutral-600 text-sm">Image {n}</span>
            </div>
          ))}
        </div>
      </section>
